...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.helloworld.HelloRequest,
      com.example.grpc.helloworld.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.grpc.helloworld.HelloRequest.class,
      responseType = com.example.grpc.helloworld.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.helloworld.HelloRequest,
      com.example.grpc.helloworld.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.helloworld.HelloRequest, com.example.grpc.helloworld.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.helloworld.HelloRequest, com.example.grpc.helloworld.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.helloworld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.helloworld.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.example.grpc.helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.helloworld.HelloResponse> responseObserver) {
  ...
  public static final class GreeterStub
     ...
     * </pre>
     */
    public void sayHello(com.example.grpc.helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.helloworld.HelloResponse> responseObserver) {
  ...
  public static final class GreeterBlockingStub
     ...
     * </pre>
     */
    public com.example.grpc.helloworld.HelloResponse sayHello(com.example.grpc.helloworld.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.helloworld.HelloResponse> sayHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.grpc.helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.helloworld.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpc.helloworld.HelloRequest,
              com.example.grpc.helloworld.HelloResponse>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.helloworld.HelloWorldServiceImpl.getDescriptor();
    }
